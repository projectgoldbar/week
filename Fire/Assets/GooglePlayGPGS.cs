...
public class GooglePlayGPGS : MonoBehaviour
{
    ...
    public void AchievementsReportProgress(string AchievementsID , double progressvalue)
    {
        Social.ReportProgress(AchievementsID, progressvalue, (bool success) => 
        {
    ...
    {
        if (Authenticated)
            GoogleLederBoardPostingScore(GPGSIds.leaderboard,long.Parse(field.text));
    }
