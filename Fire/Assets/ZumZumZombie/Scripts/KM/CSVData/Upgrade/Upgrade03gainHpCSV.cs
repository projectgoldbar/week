...
public class Upgrade03gainHpCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade03gainHpCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade03gainHpCSV> list)
    {
        ...
        Upgrade03gainHpCSV infoCurr;
        Upgrade03gainHpCSV infoDefault = new Upgrade03gainHpCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade03gainHpCSV();
