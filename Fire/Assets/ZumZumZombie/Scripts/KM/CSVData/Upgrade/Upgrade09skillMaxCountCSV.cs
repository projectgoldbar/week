...
public class Upgrade09skillMaxCountCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade09skillMaxCountCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade09skillMaxCountCSV> list)
    {
        ...
        Upgrade09skillMaxCountCSV infoCurr;
        Upgrade09skillMaxCountCSV infoDefault = new Upgrade09skillMaxCountCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade09skillMaxCountCSV();
