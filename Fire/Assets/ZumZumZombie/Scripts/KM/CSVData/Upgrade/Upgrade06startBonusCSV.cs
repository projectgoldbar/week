...
public class Upgrade06startBonusCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade06startBonusCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade06startBonusCSV> list)
    {
        ...
        Upgrade06startBonusCSV infoCurr;
        Upgrade06startBonusCSV infoDefault = new Upgrade06startBonusCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade06startBonusCSV();
