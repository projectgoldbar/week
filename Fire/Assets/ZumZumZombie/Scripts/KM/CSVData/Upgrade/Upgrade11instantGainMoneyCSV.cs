...
public class Upgrade11instantGainMoneyCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade11instantGainMoneyCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade11instantGainMoneyCSV> list)
    {
        ...
        Upgrade11instantGainMoneyCSV infoCurr;
        Upgrade11instantGainMoneyCSV infoDefault = new Upgrade11instantGainMoneyCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade11instantGainMoneyCSV();
