...
public class Upgrade01decelerationHpCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade01decelerationHpCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade01decelerationHpCSV> list)
    {
        ...
        Upgrade01decelerationHpCSV infoCurr;
        Upgrade01decelerationHpCSV infoDefault = new Upgrade01decelerationHpCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade01decelerationHpCSV();
