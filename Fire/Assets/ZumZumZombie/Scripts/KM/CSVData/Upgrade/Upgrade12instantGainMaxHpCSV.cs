...
public class Upgrade12instantGainMaxHpCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade12instantGainMaxHpCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade12instantGainMaxHpCSV> list)
    {
        ...
        Upgrade12instantGainMaxHpCSV infoCurr;
        Upgrade12instantGainMaxHpCSV infoDefault = new Upgrade12instantGainMaxHpCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade12instantGainMaxHpCSV();
