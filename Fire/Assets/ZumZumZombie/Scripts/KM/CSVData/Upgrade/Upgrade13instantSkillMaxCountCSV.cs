...
public class Upgrade13instantSkillMaxCountCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade13instantSkillMaxCountCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade13instantSkillMaxCountCSV> list)
    {
        ...
        Upgrade13instantSkillMaxCountCSV infoCurr;
        Upgrade13instantSkillMaxCountCSV infoDefault = new Upgrade13instantSkillMaxCountCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade13instantSkillMaxCountCSV();
