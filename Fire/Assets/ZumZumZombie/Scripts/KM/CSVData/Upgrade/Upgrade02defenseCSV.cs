...
public class Upgrade02defenseCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade02defenseCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade02defenseCSV> list)
    {
        ...
        Upgrade02defenseCSV infoCurr;
        Upgrade02defenseCSV infoDefault = new Upgrade02defenseCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade02defenseCSV();
