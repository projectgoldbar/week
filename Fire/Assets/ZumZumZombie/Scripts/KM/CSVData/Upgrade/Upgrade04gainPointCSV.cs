...
public class Upgrade04gainPointCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade04gainPointCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade04gainPointCSV> list)
    {
        ...
        Upgrade04gainPointCSV infoCurr;
        Upgrade04gainPointCSV infoDefault = new Upgrade04gainPointCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade04gainPointCSV();
