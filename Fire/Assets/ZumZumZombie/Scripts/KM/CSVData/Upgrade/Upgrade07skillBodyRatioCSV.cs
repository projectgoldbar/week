...
public class Upgrade07skillBodyRatioCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade07skillBodyRatioCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade07skillBodyRatioCSV> list)
    {
        ...
        Upgrade07skillBodyRatioCSV infoCurr;
        Upgrade07skillBodyRatioCSV infoDefault = new Upgrade07skillBodyRatioCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade07skillBodyRatioCSV();
