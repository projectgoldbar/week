...
public class Upgrade00maxHpCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade00maxHpCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade00maxHpCSV> list)
    {
        ...
        Upgrade00maxHpCSV infoCurr;
        Upgrade00maxHpCSV infoDefault = new Upgrade00maxHpCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade00maxHpCSV();
