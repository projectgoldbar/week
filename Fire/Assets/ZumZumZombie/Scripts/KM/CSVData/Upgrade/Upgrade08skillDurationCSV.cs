...
public class Upgrade08skillDurationCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade08skillDurationCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade08skillDurationCSV> list)
    {
        ...
        Upgrade08skillDurationCSV infoCurr;
        Upgrade08skillDurationCSV infoDefault = new Upgrade08skillDurationCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade08skillDurationCSV();
