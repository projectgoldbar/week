...
public class Upgrade14instantGainHpCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade14instantGainHpCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade14instantGainHpCSV> list)
    {
        ...
        Upgrade14instantGainHpCSV infoCurr;
        Upgrade14instantGainHpCSV infoDefault = new Upgrade14instantGainHpCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade14instantGainHpCSV();
