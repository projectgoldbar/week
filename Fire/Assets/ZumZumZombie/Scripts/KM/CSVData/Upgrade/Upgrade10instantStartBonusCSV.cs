...
public class Upgrade10instantStartBonusCSV
{
    private int m_level;
    ...
    public void Parse(string[] values, int index, Upgrade10instantStartBonusCSV defaultValue)
    {
        int arrayIndex = 0;
    ...
    static public void LoadCSV(string fileName, List<Upgrade10instantStartBonusCSV> list)
    {
        ...
        Upgrade10instantStartBonusCSV infoCurr;
        Upgrade10instantStartBonusCSV infoDefault = new Upgrade10instantStartBonusCSV();
        ...
        for (int i = 0; i < numRow; ++i)
        {
            ...
            {
                infoCurr = new Upgrade10instantStartBonusCSV();
